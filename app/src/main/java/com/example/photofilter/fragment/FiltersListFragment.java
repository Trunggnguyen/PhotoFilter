...
import com.example.photofilter.activity.MainActivity;
import com.example.photofilter.adapter.ThumbnailsAdapter;
import com.example.photofilter.adapter.ThumbnailsAdapterListener;
import com.example.photofilter.uitls.BitmapUtils;
import com.example.photofilter.uitls.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = MainActivity.originalImage;
                } else {
